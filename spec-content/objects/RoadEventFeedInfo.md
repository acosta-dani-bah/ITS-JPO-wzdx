...
`license` | URL | Identifies the [Createtive Commons Zero (CC0)](https://creativecommons.org/share-your-work/public-domain/cc0/) license underwhich a feed is published.  Licensing the data as public domain fosters data sharing. | Required | Value: [`https://creativecommons.org/publicdomain/zero/1.0/legalcode`](https://creativecommons.org/publicdomain/zero/1.0/legalcode)
